...
Home Assistant iconsets are monochrome by design. The custom icons use the current Home Assistant icon color. Use the SVG files in `dist/assets` when a dashboard needs the colored app artwork.
