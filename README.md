...
The feeding card renders its `ha-card` in light DOM instead of shadow DOM. This keeps the card compatible with themes and card-mod rules that style normal Home Assistant cards, including glass/transparency themes.
